...
<script type="text/javascript" src="js/XXViewRegulation.js"></script>
...
<div id="searchRegulation">
		<span style="font-size:12px">标题：</span> <input type="text" name="searchRegulationTitle" id="searchRegulationTitle" style="width:400px;">
		<input id="searchRegulationBtn" type="button" value="查询">
	...
	<div id="viewRegulation" style="display: none;">
		<div id="view">
